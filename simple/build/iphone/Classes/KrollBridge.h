...
@interface SimpledemoObject : KrollCoverageObject {
#else
@interface SimpledemoObject : KrollObject {
#endif
@private
...
extern NSString * Simpledemo$ModuleRequireFormat;
