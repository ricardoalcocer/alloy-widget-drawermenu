...
//@interface SimpledemoObject : NSObject
//@end

@interface SimpledemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SimpledemoObject class]])
		{
			for (NSString *key in [[(SimpledemoObject*)o modules] allKeys])
			{
