...
@interface DrawerDemoObject : KrollCoverageObject {
#else
@interface DrawerDemoObject : KrollObject {
#endif
@private
...
extern NSString * DrawerDemo$ModuleRequireFormat;
