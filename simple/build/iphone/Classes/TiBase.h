...
// in simulator we redefine to format for Simpledemo Developer console
...
{\
	NSString * exceptionName = [@"org.simpledemo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.simpledemo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISimpledemoNativeItemNone = -1, 
	UISimpledemoNativeItemSpinner = -2,
	UISimpledemoNativeItemProgressBar = -3,
	
	UISimpledemoNativeItemSlider = -4,
	UISimpledemoNativeItemSwitch = -5,
	UISimpledemoNativeItemMultiButton = -6,
	UISimpledemoNativeItemSegmented = -7,
	
	UISimpledemoNativeItemTextView = -8,
	UISimpledemoNativeItemTextField = -9,
	UISimpledemoNativeItemSearchBar = -10,
	
	UISimpledemoNativeItemPicker = -11,
	UISimpledemoNativeItemDatePicker = -12,
	
	UISimpledemoNativeItemInfoLight = -13,
	UISimpledemoNativeItemInfoDark = -14,
	
	UISimpledemoNativeItemDisclosure = -15,
	
	UISimpledemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Simpledemo instances of
