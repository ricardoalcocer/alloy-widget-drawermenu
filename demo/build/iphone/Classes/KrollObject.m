...
//@interface DrawerDemoObject : NSObject
//@end

@interface DrawerDemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DrawerDemoObject class]])
		{
			for (NSString *key in [[(DrawerDemoObject*)o modules] allKeys])
			{
