...
/**
 Base class for all Simpledemo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Simpledemo view hierarchy (such as wrapped iOS UIViews) was touched.
